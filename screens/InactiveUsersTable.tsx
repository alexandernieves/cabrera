...
const InactiveUsersTable: React.FC = () => {
    ...
    // Datos de ejemplo de usuarios inactivos
    const inactiveUsers = [
        { id: 1, name: 'James Carter', email: 'jamescarter@example.com', role: 'User' },
        { id: 2, name: 'Sarah Anderson', email: 'sarahanderson@example.com', role: 'User' },
        { id: 3, name: 'Mark Davis', email: 'markdavis@example.com', role: 'User' },
    ];
